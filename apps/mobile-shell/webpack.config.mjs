...
/**
 * Re.Pack Webpack Configuration for Mobile Shell (v5 API)
 *
 * This configuration enables Module Federation for React Native,
 * allowing the mobile shell to load remote micro-frontends dynamically.
 *
...
export default (env) => {
  ...
  // Development remotes configuration
  const devRemotes = {
    feature_home_remote: `feature_home_remote@http://localhost:9000/${platform}/remoteEntry.js`,
  };
  ...
  return {
    ...
    plugins: [
      ...
      // Module Federation Plugin V2 for loading remote MFEs (recommended in Re.Pack 5)
